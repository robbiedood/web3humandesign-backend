...
function findDesignDate(bornDate) {
    ...
    let utcBornTime = (new Date(Date.UTC(bornDate.year, bornDate.month - 1, bornDate.day, bornDate.hour))).getTime() / 1000 / 60 / 60; // 轉成以小時為單位, month是用 monthIndex 要減 1, 轉成UTC時間比較簡單
    let ds = 83 * 24;
    let de = 93 * 24;
